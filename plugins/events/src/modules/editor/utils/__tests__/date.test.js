...
} from '@@plugins/events/editor/utils/date';

jest.mock( '@@plugins/events/elements/timezone-picker/element', () => ( {
	getItems: () => [
		{
			options: [
				{
...
afterAll( () => {
	jest.unmock( '@@plugins/events/elements/timezone-picker/element' );
} );
