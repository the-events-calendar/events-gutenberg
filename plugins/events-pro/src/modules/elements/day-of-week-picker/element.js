...
const DayOfWeekPicker = ( {
	...
	<div className={ classNames( 'tribe-editor__day-of-week-picker', className ) }>
		...
		<DayOfWeek
			...
			labelTitle={ constants.WEDNESDAY }
