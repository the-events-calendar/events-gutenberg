 ...
 */
class Tribe__Gutenberg__Tickets__Attendee_Registration {
	public $post;
	public $ticket_id;
	public $ticket;
	...
	public function success_notice() {
		return '<div class="success"><p>' . __( 'Attendee Registration fields saved.', 'events-gutenberg' ) . '</p></div>';
	}
			...
			jQuery( function ( $ ) {
				$( '#poststuff' ).on( 'change', 'input, select, textarea', function () {
					...
					window.onbeforeunload = function() {
						return confirm( <?php esc_js( __( 'Are you sure you want to leave this page?', 'events-gutenberg' ) );?> );
					};
				} );
