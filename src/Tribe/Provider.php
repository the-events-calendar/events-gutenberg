...
class Tribe__Events_Gutenberg__Provider extends tad_DI52_ServiceProvider {
	...
	public function register() {
		...
		$this->container->singleton( 'gutenberg.blocks.rsvp', 'Tribe__Events_Gutenberg__Blocks__Rsvp' );
	...
	protected function hook() {
		...
		add_action( 'tribe_events_editor_register_blocks', tribe_callback( 'gutenberg.blocks.rsvp', 'register' ) );
	}
