...
import { getCountries, getStates, getName, getObject } from '../../utils/geo-data';
	...
	onSubmit () {
		...
		this.updateVenue( {
			...
			meta: {
				...
				_VenueCity: city,
				_VenueCountry: getName( country, getObject( 'tribe_data_countries' ) ) || country,
				_VenueProvince: getName( stateProvince, getObject( 'tribe_data_us_states' ) ) || stateProvince,
				_VenueZip: zip,
				_VenuePhone: phone,
				_VenueURL: website,
