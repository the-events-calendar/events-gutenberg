...
test( 'removeEmptyStrings', () => {
	...
	expect( removeEmptyStrings( { a: undefined, b: null, c: '' } ) ).toEqual( { a: undefined, b: null } );
	expect( removeEmptyStrings( { a: undefined, b: null, c: 'false' } ) ).toEqual( { a: undefined, b: null, c: 'false' } );
} );
